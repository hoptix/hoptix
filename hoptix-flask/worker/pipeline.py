...
def upsert_grades(db: Supa, tx_ids: List[str], grades: List[Dict]):
    ...
    for tx_id, g in zip(tx_ids, grades):
        ...
        grads.append({
            ...
            "upsell_main_items": d.get("upsell_main_items"),
            "upsell_addon_items": d.get("upsell_addon_items"),
            "num_upsell_offers": d.get("num_upsell_offers"),
            "upsell_offered_main": d.get("upsell_offered_main"),
            "num_upsell_offered_main": d.get("num_upsell_offered_main"),
            "num_upsell_offered_addon": d.get("num_upsell_offered_addon"),
            "upsell_offered_addon": d.get("upsell_offered_addon"),
            "num_upsell_success": d.get("num_upsell_success"),
            "upsell_success_main": d.get("upsell_success_main"),
            "num_upsell_success_addon": d.get("num_upsell_success_addon"),
            "upsell_success_addon": d.get("upsell_success_addon"),
            
            # Upsize fields
            "num_upsize_opportunities": d.get("num_upsize_opportunities"),
            "upsize_items": d.get("upsize_items"),
            "num_upsize_offers": d.get("num_upsize_offers"),
            "upsize_offered": d.get("upsize_offered"),
            "num_upsize_offered": d.get("num_upsize_offered"),
            "num_upsize_success": d.get("num_upsize_success"),
            "upsize_success": d.get("upsize_success"),
            
            # Addon fields
            "num_addon_opportunities": d.get("num_addon_opportunities"),
            "addon_main_items": d.get("addon_main_items"),
            "addon_topping_items": d.get("addon_topping_items"),
            "num_addon_offered_main": d.get("num_addon_offered_main"),
            "addon_offered_main": d.get("addon_offered_main"),
            "num_addon_offered_topping": d.get("num_addon_offered_topping"),
            "addon_offered_topping": d.get("addon_offered_topping"),
            "num_addon_success_main": d.get("num_addon_success_main"),
            "addon_success_main": d.get("addon_success_main"),
            "num_addon_success_topping": d.get("num_addon_success_topping"),
            "addon_success_topping": d.get("addon_success_topping"),
